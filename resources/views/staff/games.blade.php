				  ...
				  <div class="modal-dialog modal-lg" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        ...
				        <h4 class="modal-title" id="myModalLabel{{$student->studentNo}}">GAMES DEPARTMENT</h4>
				      </div>
				      <div class="modal-body">
				    	...
				    	<!-- display form -->
				      		<form method="post" action="{{ action('GamesController@clear') }}">
								<h3><b>GAMES DEPARTMENT</b></h3>
								<div>
